...
export type Editor = { kind: "client"; record?: Client } | { kind: "project"; record?: Project } | { kind: DocumentKind; record?: DocumentRecord; source?: DocumentRecord; projectId?: string; projectItems?: ProjectItem[] };
